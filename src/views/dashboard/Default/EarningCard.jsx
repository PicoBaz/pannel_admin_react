            ...
            <Grid container direction="column">
                  ...
                  <Grid>
                    ...
                    >
                      <MenuItem onClick={handleClose}>
                        <GetAppTwoToneIcon sx={{ mr: 1.75 }} /> وارد کردن کارت
                      </MenuItem>
                      <MenuItem onClick={handleClose}>
                        <FileCopyTwoToneIcon sx={{ mr: 1.75 }} /> کپی دیتا
                      </MenuItem>
                      <MenuItem onClick={handleClose}>
                        <PictureAsPdfTwoToneIcon sx={{ mr: 1.75 }} /> خروجی
                      </MenuItem>
                      <MenuItem onClick={handleClose}>
                        <ArchiveTwoToneIcon sx={{ mr: 1.75 }} /> آرشیو فایل
                      </MenuItem>
                    </Menu>
                  </Grid>
                </Grid>
              ...
              <Grid>
                <Grid container sx={{ alignItems: 'center' }}>
                  <Grid>
                    <Typography sx={{ fontSize: '2.125rem', fontWeight: 500, mr: 1, mt: 1.75, mb: 0.75 }}>۱۰۰،۰۰۰ ﷼</Typography>
                  </Grid>
                  <Grid>
                    <Avatar
                      sx={{
